    ...
    return (
        <section className='classeOutlet'>
            <div className='classeName'>
                <h3>{classes[0].classe_name}</h3>
                <h4>{classes[0].alias}</h4>
            </div>

            <h4 className='txtClasseDesc'>Description</h4>
            <p className='classeDesc'>{classes[0].description}</p>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td></td>
                                <td>{classes[0].strength - 50}</td>
                                <td>{classes[0].strength}</td>
                                <td>{classes[0].strength + 100}</td>
                                <td>{classes[0].strength + 200}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[0].intelligence - 100}</td>
                                <td>{classes[0].intelligence}</td>
                                <td>{classes[0].intelligence + 100}</td>
                                <td>{classes[0].intelligence + 200}</td>
                                <td>{classes[0].intelligence + 300}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[0].chance - 20}</td>
                                <td>{classes[0].chance}</td>
                                <td>{classes[0].chance + 20}</td>
                                <td>{classes[0].chance + 40}</td>
                                <td>{classes[0].chance + 60}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[0].agility - 20}</td>
                                <td>{classes[0].agility}</td>
                                <td>{classes[0].agility + 20}</td>
                                <td>{classes[0].agility + 40}</td>
                                <td>{classes[0].agility + 60}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                ...
                <tbody>
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                <td>{classes[0].bow}%</td>
                                <td>{classes[0].wand}%</td>
                                <td>{classes[0].staff}%</td>
                                <td>{classes[0].dagger}%</td>
                                <td>{classes[0].sword}%</td>
                                <td>{classes[0].axe}%</td>
                                <td>{classes[0].hammer}%</td>
                                <td>{classes[0].shovel}%</td>
                            </tr>
                        </>
                    ) : (
                        <>
