    ...
    return (
        <section className='classeOutlet'>
            <div className='classeName'>
                <h3>{classes[11].classe_name}</h3>
                <h4>{classes[11].alias}</h4>
            </div>

            <h4 className='txtClasseDesc'>Description</h4>
            <p className='classeDesc'>{classes[11].description}</p>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[11].strength - 50}</td>
                                <td>{classes[11].strength}</td>
                                <td>{classes[11].strength + 150}</td>
                                <td></td>
                                <td></td>
                            </tr>
                        </>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[11].intelligence - 50}</td>
                                <td>{classes[11].intelligence}</td>
                                <td>{classes[11].intelligence + 150}</td>
                                <td></td>
                                <td></td>
                            </tr>
                        </>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[11].chance - 50}</td>
                                <td>{classes[11].chance}</td>
                                <td>{classes[11].chance + 150}</td>
                                <td></td>
                                <td></td>
                            </tr>
                        </>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[11].agility - 50}</td>
                                <td>{classes[11].agility}</td>
                                <td>{classes[11].agility + 150}</td>
                                <td></td>
                                <td></td>
                            </tr>
                        </>
            ...
            <table className='classeTableWeapons'>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <th><img src={"/images/weapons/axe-green.svg"} alt="Icone de la hache" className='icons-weapons'/></th>
                ...
                <tbody>
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                <td>{classes[11].bow}%</td>
                                <td>{classes[11].wand}%</td>
                                <td>{classes[11].staff}%</td>
                                <td>{classes[11].dagger}%</td>
                                <td>{classes[11].sword}%</td>
                                <td>{classes[11].axe}%</td>
                                <td>{classes[11].hammer}%</td>
                                <td>{classes[11].shovel}%</td>
                            </tr>
                        </>
                    ) : (
                        <>
