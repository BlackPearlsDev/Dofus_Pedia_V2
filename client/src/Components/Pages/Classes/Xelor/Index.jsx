    ...
    return (
        <section className='classeOutlet'>
            <div className='classeName'>
                <h3>{classes[4].classe_name}</h3>
                <h4>{classes[4].alias}</h4>
            </div>

            <h4 className='txtClasseDesc'>Description</h4>
            <p className='classeDesc'>{classes[4].description}</p>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td></td>
                                <td>{classes[4].strength}</td>
                                <td>{classes[4].strength + 50}</td>
                                <td>{classes[4].strength + 150}</td>
                                <td>{classes[4].strength + 250}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[4].intelligence - 100}</td>
                                <td>{classes[4].intelligence}</td>
                                <td>{classes[4].intelligence + 100}</td>
                                <td>{classes[4].intelligence + 200}</td>
                                <td>{classes[4].intelligence + 300}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[4].chance - 20}</td>
                                <td>{classes[4].chance}</td>
                                <td>{classes[4].chance + 20}</td>
                                <td>{classes[4].chance + 40}</td>
                                <td>{classes[4].chance + 60}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[4].agility - 20}</td>
                                <td>{classes[4].agility}</td>
                                <td>{classes[4].agility + 20}</td>
                                <td>{classes[4].agility + 40}</td>
                                <td>{classes[4].agility + 60}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                ...
                <tbody>
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                <td>{classes[4].bow}%</td>
                                <td>{classes[4].wand}%</td>
                                <td>{classes[4].staff}%</td>
                                <td>{classes[4].dagger}%</td>
                                <td>{classes[4].sword}%</td>
                                <td>{classes[4].axe}%</td>
                                <td>{classes[4].hammer}%</td>
                                <td>{classes[4].shovel}%</td>
                            </tr>
                        </>
                    ) : (
                        <>
