    ...
    return (
        <section className='classeOutlet'>
            <div className='classeName'>
                <h3>{classes[1].classe_name}</h3>
                <h4>{classes[1].alias}</h4>
            </div>

            <h4 className='txtClasseDesc'>Description</h4>
            <p className='classeDesc'>{classes[1].description}</p>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td></td>
                                <td>{classes[1].strength - 50}</td>
                                <td>{classes[1].strength}</td>
                                <td>{classes[1].strength + 100}</td>
                                <td>{classes[1].strength + 200}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[1].intelligence - 100}</td>
                                <td>{classes[1].intelligence}</td>
                                <td>{classes[1].intelligence + 100}</td>
                                <td>{classes[1].intelligence + 200}</td>
                                <td>{classes[1].intelligence + 300}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[1].chance - 100}</td>
                                <td>{classes[1].chance}</td>
                                <td>{classes[1].chance + 100}</td>
                                <td>{classes[1].chance + 200}</td>
                                <td>{classes[1].chance + 300}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[1].agility - 20}</td>
                                <td>{classes[1].agility}</td>
                                <td>{classes[1].agility + 20}</td>
                                <td>{classes[1].agility + 40}</td>
                                <td>{classes[1].agility + 60}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <th><img src={"/images/weapons/hammer-green.svg"} alt="Icone du marteau" className='icons-weapons'/></th>
                ...
                <tbody>
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                <td>{classes[1].bow}%</td>
                                <td>{classes[1].wand}%</td>
                                <td>{classes[1].staff}%</td>
                                <td>{classes[1].dagger}%</td>
                                <td>{classes[1].sword}%</td>
                                <td>{classes[1].axe}%</td>
                                <td>{classes[1].hammer}%</td>
                                <td>{classes[1].shovel}%</td>
                            </tr>
                        </>
                    ) : (
                        <>
