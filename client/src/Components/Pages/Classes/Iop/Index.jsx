    ...
    return (
        <section className='classeOutlet'>
            <div className='classeName'>
                <h3>{classes[7].classe_name}</h3>
                <h4>{classes[7].alias}</h4>
            </div>

            <h4 className='txtClasseDesc'>Description</h4>
            <p className='classeDesc'>{classes[7].description}</p>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[7].strength - 100}</td>
                                <td>{classes[7].strength}</td>
                                <td>{classes[7].strength + 100}</td>
                                <td>{classes[7].strength + 200}</td>
                                <td>{classes[7].strength + 300}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[7].intelligence - 20}</td>
                                <td>{classes[7].intelligence}</td>
                                <td>{classes[7].intelligence + 20}</td>
                                <td>{classes[7].intelligence + 40}</td>
                                <td>{classes[7].intelligence + 60}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[7].chance - 20}</td>
                                <td>{classes[7].chance}</td>
                                <td>{classes[7].chance + 20}</td>
                                <td>{classes[7].chance + 40}</td>
                                <td>{classes[7].chance + 60}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[7].agility - 20}</td>
                                <td>{classes[7].agility}</td>
                                <td>{classes[7].agility + 20}</td>
                                <td>{classes[7].agility + 40}</td>
                                <td>{classes[7].agility + 60}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                ...
                <tbody>
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                <td>{classes[7].bow}%</td>
                                <td>{classes[7].wand}%</td>
                                <td>{classes[7].staff}%</td>
                                <td>{classes[7].dagger}%</td>
                                <td>{classes[7].sword}%</td>
                                <td>{classes[7].axe}%</td>
                                <td>{classes[7].hammer}%</td>
                                <td>{classes[7].shovel}%</td>
                            </tr>
                        </>
                    ) : (
                        <>
