    ...
    return (
        <section className='classeOutlet'>
            <div className='classeName'>
                <h3>{classes[10].classe_name}</h3>
                <h4>{classes[10].alias}</h4>
            </div>

            <h4 className='txtClasseDesc'>Description</h4>
            <p className='classeDesc'>{classes[10].description}</p>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td>{classes[10].strength}</td>
                                <td>{classes[10].strength + 100}</td>
                                <td>{classes[10].strength + 150}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td>{classes[10].intelligence}</td>
                                <td>{classes[10].intelligence + 100}</td>
                                <td>{classes[10].intelligence + 150}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td>{classes[10].chance}</td>
                                <td>{classes[10].chance + 100}</td>
                                <td>{classes[10].chance + 150}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td>{classes[10].agility}</td>
                                <td>{classes[10].agility + 100}</td>
                                <td>{classes[10].agility + 150}</td>
                            </tr>
                        </>
                    ) : (
                        <>
            ...
            <table className='classeTableWeapons'>
                ...
                <tbody>
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                <td>{classes[10].bow}%</td>
                                <td>{classes[10].wand}%</td>
                                <td>{classes[10].staff}%</td>
                                <td>{classes[10].dagger}%</td>
                                <td>{classes[10].sword}%</td>
                                <td>{classes[10].axe}%</td>
                                <td>{classes[10].hammer}%</td>
                                <td>{classes[10].shovel}%</td>
                            </tr>
                        </>
                    ) : (
                        <>
