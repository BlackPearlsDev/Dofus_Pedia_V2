    ...
    return (
        <section className='classeOutlet'>
            <div className='classeName'>
                <h3>{classes[8].classe_name}</h3>
                <h4>{classes[8].alias}</h4>
            </div>

            <h4 className='txtClasseDesc'>Description</h4>
            <p className='classeDesc'>{classes[8].description}</p>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[8].strength - 50}</td>
                                <td>{classes[8].strength}</td>
                                <td>{classes[8].strength + 100}</td>
                                <td>{classes[8].strength + 200}</td>
                                <td>{classes[8].strength + 300}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[8].intelligence - 50}</td>
                                <td>{classes[8].intelligence}</td>
                                <td>{classes[8].intelligence + 100}</td>
                                <td>{classes[8].intelligence + 200}</td>
                                <td>{classes[8].intelligence + 300}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[8].chance - 20}</td>
                                <td>{classes[8].chance}</td>
                                <td>{classes[8].chance + 20}</td>
                                <td>{classes[8].chance + 40}</td>
                                <td>{classes[8].chance + 60}</td>
                            </tr>
                        </>
                    ) : (
                        <>
                    ...
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                ...
                                <td>{classes[8].agility - 50}</td>
                                <td>{classes[8].agility}</td>
                                <td>{classes[8].agility + 50}</td>
                                <td>{classes[8].agility + 100}</td>
                                <td>{classes[8].agility + 150}</td>
                            </tr>
                        </>
                    ) : (
                        <>
            ...
            <table className='classeTableWeapons'>
                <thead>
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                <th><img src={"/images/weapons/bow-green.svg"} alt="Icone de l'arc" className='icons-weapons'/></th>
                ...
                <tbody>
                    {widthScreen > 374 ? (
                        <>
                            <tr>
                                <td>{classes[8].bow}%</td>
                                <td>{classes[8].wand}%</td>
                                <td>{classes[8].staff}%</td>
                                <td>{classes[8].dagger}%</td>
                                <td>{classes[8].sword}%</td>
                                <td>{classes[8].axe}%</td>
                                <td>{classes[8].hammer}%</td>
                                <td>{classes[8].shovel}%</td>
                            </tr>
                        </>
                    ) : (
                        <>
